...
import com.quangleeit.itsecuritylearning.courses.ItemCourses;
...
public class DbManager {
    ...
    private ArrayList<ItemCourses> itemCourses;
    ...
    public void getCourseData() {
        ...
        while (!cursor.isAfterLast()) {
            ...
            itemCourses.add(new ItemCourses(title, content, favorite));
            cursor.moveToNext();
        }
        cursor.close();
        //closeDatabases();
    ...
    public ArrayList<ItemCourses> getItemCourses() {
        return itemCourses;
    }
